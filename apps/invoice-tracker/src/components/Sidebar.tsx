...
const nav = [
  ...
  { href: '/payments', label: 'Carrier Payments', icon: CreditCard },
  { href: '/loads', label: 'Loads', icon: Truck },
  { href: '/reports/aging', label: 'Aging Reports', icon: BarChart3 },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-5 py-5 border-b border-[#1A2235]">
        ...
        <div>
          <div className="text-sm font-semibold text-white leading-none">Invoice</div>
          <div className="text-xs text-[#8B95A5] mt-0.5">Tracker</div>
        </div>
      </div>
